...
class MCRoughCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        # actor obs + base linear velocity + external disturbance + height scan
        # + four 3D wheel contact forces
    ...
    class control(LeggedRobotCfg.control):
        # The shared wheeled-leg controller interprets non-wheel actions as
        # position targets and FOOT_JOINT actions as wheel velocity targets.
        control_type = "P"
        stiffness = {
            "ABAD_JOINT": 40.0,
            "HIP_JOINT": 40.0,
    ...
    class asset(LeggedRobotCfg.asset):
        file = "{LEGGED_GYM_ROOT_DIR}/resources/robots/mc/urdf/bot_mc.urdf"
        name = "mc"
        # Rigid bodies used for contact-force observations.
        foot_name = "FOOT_LINK"
...
class MCRoughCfgPPO(LeggedRobotCfgPPO):
