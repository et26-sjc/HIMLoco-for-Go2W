"""Zero-shot v2 quiet evaluation for the mild 100 Hz buffer variant."""
...
TASK = "quiet_mc_100hz_buffer_mild_zeroshot_v2"
...
def _save_results(summary, traces, event_samples, progress_arrays,
    ...
    summary["task"] = TASK
    summary["baseline"] = "MC_HIM_100Hz_Minimal_buffer_mild_zeroshot"
    summary["controller"] = "mild_postimpact_hip_knee_gain_schedule"
    ...
    summary["buffer_hold_time_s"] = 0.015
    summary["buffer_hip_knee_kp_scale"] = 0.80
    summary["buffer_hip_knee_kd_scale"] = 1.50
    summary["buffer_trigger_on_new_contact"] = False
    summary["buffer_precontact_enabled"] = False
